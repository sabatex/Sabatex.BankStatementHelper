...
namespace sabatex.Tests.BankHelper
{
    public class BankStreamConverterTests
    {
        ...
        [InlineData("UA923052990000026008050334389", testFilePath + "/Privat24.csv", EBankType.PrivatUA,1, "Privat24")]
        [InlineData("26005034006185", testFilePath + "/iBankUA.csv", EBankType.iBankUA,1, "IBankUA")]
        [InlineData("", testFilePath+ "/OTPBank_210211.zip", EBankType.iFobs,1, "iFobsXML")]
